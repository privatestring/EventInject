...
class InstSimulatedOptionPositionDetailsFragment : Fragment() {
    @Boom(index = 1)
    ...
    var parentPositionGroupBean: OptionPositionGroupBean? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        InstSimulatedOptionPositionDetailsFragmentLauncher.bind(this)
