...
class MarketStarDetailFragment : Fragment() {
    ...
    @Boom(index = 6, isOptional = true, key = "cardDataStr")
    var cardDataStr: String? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        MarketStarDetailFragmentLauncher.bind(this)
